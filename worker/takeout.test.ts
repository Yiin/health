...
//
// The fixture Takeout zip is BUILT in-test (no binary fixture committed) via
// the shared minimal zip writer (worker/zip-fixture.ts), so the walk
// exercises real decompression. Storage and the queue are injected
